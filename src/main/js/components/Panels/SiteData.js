    ...
    return (
        <div id="mid" className="col-6">
            ...
            <ul className="nav nav-tabs">
                <WebsiteTab name={"Study Guide"} linkTo={"#ALLC"}/>
            ...
            <div className="tab-content" id="myTabContent">
                ...
                <WebsiteTabContent id={"wiki"} site={"wikipedia.org"}/>
                <WebsiteTabContent id={"codesandbox"} site={"https://codesandbox.io/dashboard/recent"}/>
                <WebsiteTabContent id={"boot_docs"} site={"\"https://getbootstrap.com/docs/4.5/components/alerts/\""}/>
                <MainTab/>
