...
function CommunityTopicList(props) {
  ...
  const [
    show_InlineForm_CreateArticle,
    setShow_InlineForm_CreateArticle,
  ] = useState(false);
  let data = props.data;
  ...
  return (
    <div>
      ...
      <button
        onClick={() =>
          setShow_InlineForm_CreateArticle((prevState) => !prevState)
        }
      >
        ...
        return (
          <div>
            ...
            {topic.articles.map((article) => {
              return (
                <a
                  onClick={props.setOpenArticle(article.link)}
                  href={article.link}
                >
                  {article.name}
                </a>
...
function Section(props) {
  ...
  return (
    <div>
      ...
      <button
        onClick={() => setShowInlineDiscussion((prevState) => !prevState)}
      >
