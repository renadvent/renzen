...
function defaultText(){
    ...
    return (
        <div>
            ...
            <p>Questions must be answered with Articles. Answers are different from replies.
            Articles are separated into Q&A sections</p>
            <p>FOR ANNOTATIONS. Click on a LINE in the article, and all annotations with a section
            in that line, pop up on the left</p>
            <p>Only Annotations are allowed. The types are "Article", "Section", and "Selection"</p>
            <p>Annotations can be replied to</p>
            <p>Implement Scroll-to from both side-bar and content and content to main</p>
